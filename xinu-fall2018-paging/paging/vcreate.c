/* Modified create() to make vcreate() - pal5, Nov 14 */
#include <xinu.h>
...
/*------------------------------------------------------------------------
 *  vcreate  -  Create a process with virtual heap.
 *------------------------------------------------------------------------
 */
pid32	vcreate(
	  void		*procaddr,	/* Address of the function	*/
	  uint32	ssize,		/* Stack size in words		*/
	  uint16	hsize_in_pages,	/* Pages of Virtual Heap	*/
